...
<div class="admin-cnt">
    ...
    <form action="<?php echo base_url().index_page(); ?>deal_category/save_edit.html" class="frm-profil" method="post" id="addForm" enctype="multipart/form-data">
        <fieldset>
        <div class="clearfix">
            <label>Name*</label>
            <input type="text" class="input-profil" name="name" id="name" value="<?php echo $deal_category->name;?>" />
        </div>
        <div class="clearfix">
            <label>White icon*</label>
            <img src="<?php echo base_url().'upload/deal_category/'.$deal_category->white_icon; ?>" />
        ...
        <div class="clearfix">
            ...
            <img src="<?php echo base_url().'upload/deal_category/'.$deal_category->red_icon; ?>" />
            <input type="file" name="red_icon" id="red_icon" style="margin-bottom:10px; height:26px; background:none !important;" />
        </div>
        <input type="hidden" name="id" value="<?php echo $deal_category->id;?>" />
