...
<div class="admin-cnt">
    ...
    <form action="<?php echo base_url().index_page(); ?>b2b_user/save_add.html" class="frm-profil" method="post" id="addForm" enctype="multipart/form-data">
        <fieldset>
        <div class="clearfix">
            <label>Name*</label>
        ...
        <div class="clearfix">
            <label>Company*</label>
            <input type="text" class="input-profil" name="company" id="company" value="" />
        </div>
        <div class="clearfix">
            <label>Image*</label>
        ...
        <div class="clearfix">
            <label>Link</label>
            <input type="text" class="input-profil" name="web" id="web" value=""/>
        </div>
        <div class="clearfix">
