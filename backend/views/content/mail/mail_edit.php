...
<div class="ad-content">
    ...
    <form action="<?php echo base_url().index_page(); ?>mail/save_edit.html" class="frm-profil" method="post" id="addForm">
        <fieldset>
        <div class="clearfix">
            <label>Title*</label>
            <input type="text" class="input-profil" name="title" id="title" value="<?php echo $mail->title;?>" />
        </div>
        <div class="clearfix">
            <label>Content*</label>
            <div class="input-profil" style="background:none; border:none;">
            <textarea name="content" rows="20" cols="50"><?php echo $mail->content;?></textarea>
            </div>
        </div>
