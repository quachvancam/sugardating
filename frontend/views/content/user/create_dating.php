...
<div id="f-inviteVIP" class="reveal-modal">
  <div class="p-content3 clear-fix">
    ...
    <ul class="list_vipmember clearfix">
        ...
        <?php echo $img;?>
        <article>
          <h4>Profilnavn: <?php echo $user->name;?></h4>
          <p>Profilnr. <?php echo $user->id;?> - <?php echo $own[$user->own];?></p>
...
<div class="clearfix bgContent m-t-3" id="sugarDates">
    <div class="contentLeft">
        ...
        <div class="info-profil">
            ...
            <?php echo form_open('user/save_dating', array('method'=>'post', 'name'=>'myform', 'id'=>'myform', 'class'=>'frm-profil'));?>
                <fieldset>
                    <label>Opret en VIP invitation</label><br />
                    ...
                    <label>Opret nyt Dateopslag</label><br />
                    <input class="input-profil" style="width:263px" value="" type="text" name="title" id="title"/>
                    <div class="question-mark" style="float:left; margin: 0 3px;">
                        <div class="common-popup">
                            <div class="top"><span class="arrow"></span></div>
                            <div class="content">
                    ...
                    <select  class="input-profil" name="order_item_id" id="websites1" style="width:280px;" >
                        ...
                        <option class="<?php echo $cat_icon_array[$voucher->category_id];?>" value="<?php echo $voucher->id;?>"><?php echo $voucher->name.' : '.$voucher->codes;?></option>
                        <?php }?>
                    </select><br />
                    <label style="margin-top: 10px;">Udløbstidspunkt</label><br />
                    <div class="clearfix"></div>
                    ...
                    <label>Udløbsdato</label><br />
                    <input id="datepicker" name="date" type="text" class="input-profil w264" value="" style="background: #fff url('<?php echo base_url();?>assets/frontend/img/calendar.gif') right no-repeat; cursor:pointer; color:#000;border: 1px solid #393232;" />
                    <label>Beskrivelse</label><br />
                    <textarea class="input-profil w510" name="description" id="description"></textarea><br />
                    <div class="clearfix"></div>
                    <input type="submit" class="btn-savedating" style="cursor:pointer; border:none; float:left;" />
                    <a class="btn-canel1" href="<?php echo base_url().index_page()?>user/datinglist.html">Annullér</a>
                </fieldset>
            </form>
        </div>
    </div>
