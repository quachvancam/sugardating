   ...
   <div class="col-profil clearfix">
    ...
    <div class="movieDate clearfix">
      <div class="w-letMovie">
        ...
        <div style="margin-bottom: 5px; padding:0 0 5px 0; border-bottom: 1px solid #231010;">
            ...
            <div class="letMovie-bottom clearfix">
                ...
                <div style="float:right; font-size:15px; padding-top:5px;">
                    <?php if($rows['publish']==0&&$rows['used']==0){?>
                        <a style="background: #640c0c; border-radius:5px; display: inline; padding: 5px 15px; font-weight:bold;" href="<?php echo base_url().index_page();?>user/toapply/<?php echo $rows['id'];?>/used.html">Acceptér</a>
                        <a style="background: #640c0c; border-radius:5px; display: inline; padding: 5px 15px; font-weight:bold;" href="<?php echo base_url().index_page();?>user/toapply/<?php echo $rows['id'];?>/publish.html">Afvis</a>
                    <?php }else{?>
                        <a style="background: #640c0c; border-radius:5px; display: inline; padding: 5px 15px; font-weight:bold;" href="<?php echo base_url().index_page();?>user/sletvip/<?php echo $rows['id'];?>.html">Slet</a>
                        <?php if($rows['used']==1){?>
                        <span style="color: #44da75; font-weight:bold;"><img style="vertical-align: middle;" src="<?php echo base_url();?>assets/frontend/img/pub-ico.png" />Accepteret</span>
                        <?php }else if($rows['publish']==1){?>
                        <span style="padding: 0 12px; color:#ffea17;font-weight:bold;">Afvist</span>
                        <?php }?>
                    <?php }?>
                </div>
            </div>
        ...
        <?php }}else{?>
            <div>
                Endnu ingen invitationer. Prøv at oprette dit eget Date Opslag, og se hvad der sker!
            </div>
