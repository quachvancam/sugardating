...
<title>Sugardating - En Database Fejl Opstod!</title>
</head>
<body>
<div id="page">
    ...
    <div id="main">
      <div class="indexPage">
        ...
        <div style="min-height: 400px; font-size: 25px;">
            En Database Fejl Opstod! <a href="<?php echo base_url().index_page();?>index.html"><img style="vertical-align: middle;" src="<?php echo base_url();?>assets/frontend/img/btnGohome.png" /></a>
        </div>
        </div>
        </div>
      </div>
